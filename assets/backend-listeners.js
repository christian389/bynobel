document.addEventListener("shopify:section:load", function (event) {
  ...
  if (section.classList.contains("recently-viewed-products") || event.srcElement.getElementsByClassName("recently-viewed-products").length) {
  ...
  if (event.detail.sectionId.endsWith("main-password") || event.detail.sectionId.endsWith("main-giftcard") || event.detail.sectionId.endsWith("main-404")) {
    window.background();
  }
...
document.addEventListener("shopify:block:select", function (event) {
  ...
  if (
      section.querySelector(".m6tb") != null &&
    ...
    Array.from(
        tabs.querySelectorAll("li[data-index], div[data-index]")
    ).forEach(function (el) {
    ...
    tabs
        .querySelector("li[data-index='" + tabIndex + "']")
        .classList.add(active_class);
    tabs
        .querySelector("div[data-index='" + tabIndex + "']")
